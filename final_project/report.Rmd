...
Our analysis uses the following variables of [NHANES 2017-2018](https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?BeginYear=2017). The R/STATA codes are stored [here](https://github.com/mk-repos/Stats506_public/tree/master/final_project).
...
Table 1 shows the results of (a). People with assistance tend to visit hospitals more often, and the association is significant.
