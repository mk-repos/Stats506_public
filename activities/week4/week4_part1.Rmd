...
```{r q4}
Orange = Orange %>%
  mutate(avg_growth_rate = circumference / age)
head(Orange)
```
...
Each row contains information about the average growth rate over 5 types of trees at a measure point in their life. The columns contain the information about the average growth rate and the standard error.
